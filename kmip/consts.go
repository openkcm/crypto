...
var (
	// AES_CBC_PKCS5 defines kryptongraphic parameters for AES encryption using CBC mode with PKCS5 padding.
	...
	// AES_GCM defines the kryptongraphic parameters for AES encryption using Galois/Counter Mode (GCM).
	...
	// RSA_OAEP_SHA256 defines kryptongraphic parameters for RSA encryption using OAEP padding with SHA-256 as the hashing algorithm.
	// It specifies the use of the RSA kryptongraphic algorithm, SHA-256 for both the primary and mask generator hashing algorithms,
	...
	// RSA_OAEP_SHA384 defines kryptongraphic parameters for RSA encryption using OAEP padding with SHA-384 as the hashing algorithm.
	// It specifies the use of the RSA kryptongraphic algorithm, SHA-384 for both the primary and mask generator hashing algorithms,
	...
	// RSA_OAEP_SHA512 defines kryptongraphic parameters for RSA encryption using OAEP padding with SHA-512 as the hashing algorithm.
	// It specifies the use of the RSA kryptongraphic algorithm, SHA-512 for both the primary and mask generator hashing algorithms,
