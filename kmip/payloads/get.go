...
func (pl *GetResponsePayload) Secret() ([]byte, error) {
	...
	if !ok {
		return nil, errors.New("Object does not implement Data() method")
	}
	return secret.Data()
}
...
func (pl *GetResponsePayload) SymmetricKey() ([]byte, error) {
	...
	if !ok {
		return nil, errors.New("Object does not implement KeyMaterial() method")
	}
...
func (pl *GetResponsePayload) X509Certificate() (*x509.Certificate, error) {
	...
	if !ok {
		return nil, errors.New("Object does not implement X509Certificate() method")
	}
...
func (pl *GetResponsePayload) PemCertificate() (string, error) {
	...
	if !ok {
		return "", errors.New("Object does not implement PemCertificate() method")
	}
...
func (pl *GetResponsePayload) RsaPrivateKey() (*rsa.PrivateKey, error) {
	...
	if !ok {
		return nil, errors.New("Object does not implement RSA() method")
	}
	return key.RSA()
}
...
func (pl *GetResponsePayload) PemPrivateKey() (string, error) {
	...
	if !ok {
		return "", errors.New("Object does not implement Pkcs8Pem() method")
	}
	return key.Pkcs8Pem()
}
...
func (pl *GetResponsePayload) PemPublicKey() (string, error) {
	...
	if !ok {
		return "", errors.New("Object does not implement PkixPem() method")
	}
	return key.PkixPem()
}
