...
//
// The request contains information about the kryptongraphic parameters (mode and padding method), the data to be encrypted,
// and the IV/Counter/Nonce to use. The kryptongraphic parameters MAY be omitted from the request as they can be specified as
// associated attributes of the Managed Cryptographic Object. The IV/Counter/Nonce MAY also be omitted from the request if the kryptongraphic
...
type EncryptRequestPayload struct {
	...
	//
	// The Correlation Value is used in requests and responses in kryptongraphic operations that support multi-
	...
	// subsequent kryptongraphic operations that pertain to the original operation.
	CorrelationValue []byte `ttlv:",omitempty,version=v1.3.."`
	// Initial operation as Boolean.
	//
	// The Init Indicator is used in requests in kryptongraphic operations that support multi-part (streaming)
	...
	//
	// The Final Indicator is used in requests in kryptongraphic operations that support multi-part (streaming)
...
//
// The request contains information about the kryptongraphic parameters (mode and padding method), the data to be decrypted, and the IV/Counter/Nonce to use.
// The kryptongraphic parameters MAY be omitted from the request as they can be specified as associated attributes of the Managed Cryptographic Object.
